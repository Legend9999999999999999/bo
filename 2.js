...
var bot_token = '5299685658:AAEh439ePTv6BM6t5nAPkvNvtBOMCQ8I1dw'; //YOUR BOT TOKEN HERE
var bot_name = 'RupeeCash_Bot'; // Bot Name
...
const admin_id = 827167974;
const admin_id2 = 1468706824;
var mongo_url = 'mongodb+srv://anand123:fmxjB56uDFtz2DU3@cluster0.ncwnx.mongodb.net/myFirstDatabase?retryWrites=true&w=majority'; // Your Mongo URL Here
const buttonsLimit = {
    window: 1000,
    limit: 1,
        ...
        if (bots == 'Active') {
            ...
            if (flag == channel.length) {
                ...
                if (statdata.length == 0) {
                    ...
                    ctx.reply(
                        '<b>📊 Bot Live Stats 📊\n\n📤 Total Payouts : 0 ' + currency + '\n\n💡 Total Users: ' + members.length + ' Users\n\n✅ Created By : <a href="tg://user?id=827167974">Devil Boys</a></b>' , { parse_mode: 'html', reply_markup: { keyboard: [['💰 Balance'], ['👫 Invite', '🎁 Bonus', '🗂 Wallet'], ['💵 Withdraw', '📊 Statistics']], resize_keyboard: true } }
                    )
                } else {
